...
int main(int argc, char * argv[])
{
  ...
  desc.add_options()
      ...
      ("refh", po::value<float > (&refh)->default_value(2.f), "x size of the bin, if smaller than (eq) 0, use the whole box")
      ("yz-size", po::value<float > (&yzSize), "yz size of the bin, if smaller than (eq) 0, use the whole box")
