...
int main(int argc, char * argv[])
{
  ...
  std::string ifile, ofile, method, corr3file;
  ValueType x0, x1;
  ...
  desc.add_options()
      ...
      ("corr3out",   po::value<std::string > (&corr3file)->default_value ("corr3"), "the output file of corr3");
  ...
  std::cout << "# corr3out: " << corr3file << std::endl;
  std::cout << "###################################################" << std::endl;  
