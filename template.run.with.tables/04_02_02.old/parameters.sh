...
# ibi parameters
ibi_iterations_max=5

ibi_gmx_nsteps=100000
ibi_gmx_nstenergy=100
ibi_gmx_nstxtcout=100

# tf parameters
tf_iterations_max=1
tf_iterations_init=15
...
# productive run.
prod_gmx_nsteps=10000000
prod_gmx_nstenergy=200
prod_gmx_nstxtcout=200
