...
spl 'rerun.water.wca/rdf3.inter.9//rdf3.375-425.00.270.out' u 1:2:($3) every 2 not

set origin -0.0, 0.38
unset title
# set ylabel 'HY I'
spl 'rerun.water.wca/rdf3.inter.9//rdf3.425-516.00.270.out' u 1:2:($3) every 2 not

set origin -0.0, 0.19
unset title
# set ylabel 'HY II'
spl 'rerun.water.wca/rdf3.inter.9//rdf3.516-608.00.270.out' u 1:2:($3) every 2 not

set origin -0.0, 0.0
unset title
set xlabel "h_1 [nm]" 
# set ylabel 'HY III'
spl 'rerun.water.wca/rdf3.inter.9//rdf3.608-700.00.270.out' u 1:2:($3) every 2 not
...
spl 'rerun.water.wca/rdf3.inter.9//rdf3.375-425.00.330.out' u 1:2:($3) every 2 not

set origin 0.66, 0.57
spl 'rerun.water.wca/rdf3.inter.9//rdf3.375-425.00.800.out' u 1:2:($3) every 2 not


set origin 0.33, 0.38
spl 'rerun.water.wca/rdf3.inter.9//rdf3.425-516.00.330.out' u 1:2:($3) every 2 not

set origin 0.66, 0.38
spl 'rerun.water.wca/rdf3.inter.9//rdf3.425-516.00.800.out' u 1:2:($3) every 2 not


set origin 0.33, 0.19
spl 'rerun.water.wca/rdf3.inter.9//rdf3.516-608.00.330.out' u 1:2:($3) every 2 not

set origin 0.66, 0.19
spl 'rerun.water.wca/rdf3.inter.9//rdf3.516-608.00.800.out' u 1:2:($3) every 2 not


set xlabel "h_1 [nm]"
set origin 0.33, 0.0
spl 'rerun.water.wca/rdf3.inter.9//rdf3.608-700.00.330.out' u 1:2:($3) every 2 not

set origin 0.66, 0.0
spl 'rerun.water.wca/rdf3.inter.9//rdf3.608-700.00.800.out' u 1:2:($3) every 2 not
