...
set out 'fig-rdf-all-425-516.eps'
...
'run.04_02_02.atom/rdf.inter.9/rdf.hh.425-516.out' w l ls 11 t 'H-H EX',\
'run.04_02_02.atom/rdf.inter.9/rdf.oh.425-516.out' w l ls 12 t 'O-H EX',\
'rerun.water.wca/rdf.inter.9/rdf.425-516.out' w l ls 3 t 'COM-COM WCA AdResS',\
'rerun.water.wca/rdf.inter.9/rdf.hh.425-516.out' w l ls 31 t 'H-H WCA AdResS',\
'rerun.water.wca/rdf.inter.9/rdf.oh.425-516.out' w l ls 32 t 'O-H WCA AdResS'
#'plot.rdf.box.1' w l ls 10 not

# 'run.04_02_02.old.noibi/rdf.inter.9/rdf.hh.425-516.out' w l ls 2 t 'TFI old w',\
# 'run.04_02_02.old.noibi/rdf.inter.9/rdf.oh.425-516.out' w l ls 21 t 'TFI old w',\
# 'rerun.04_02_02.step.000.tf/rdf.inter.9/rdf.hh.425-516.out' w l ls 3 t 'TFI new w',\
# 'rerun.04_02_02.step.000.tf/rdf.inter.9/rdf.oh.425-516.out' w l ls 31 t 'TFI new w',\
