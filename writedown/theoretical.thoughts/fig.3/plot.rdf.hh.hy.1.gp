...
# pl\
# 'run.04_02_02.atom/rdf.inter.9/rdf.hh.425-516.out' w l ls 1 not 'EX',\
...
pl 1 ls 20 not,\
'run.04_02_02.atom/rdf.inter.9/rdf.hh.425-516.out' w l ls 1 t 'EX',\
...
'run.04_02_02.allCorr/rdf.inter.9/rdf.hh.425-516.out' w l ls 4 t 'TFI-IBI new w'
