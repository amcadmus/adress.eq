...
The arguments we have used so far are not sufficient to infer that the probability $p(\vect x_1 , N_1)$, as presented in the theoretical anlysis, corresponds to that of a grand canonical distribution  Eqn.~\eqref{eqn:p}.
