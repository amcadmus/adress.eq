...
\end{align}
\redc{It must be noticed that the writing of the formula above is possible because the long-range electrostatic interaction is treated by the reaction
