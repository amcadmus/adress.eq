\documentclass[aps,prb,preprint,citeautoscript]{revtex4}
% \documentclass[acs,jctc,preprint]{revtex4}
...
It is anyway obvious that the approach is non Hamiltonian, that is, it does not exists a potential from which the force of Eq.\ref{force} can be derived. \redc{In practice, the energy drift of the system is taken care by a Langevin thermostat with globally uniform parameters.} This has been shown both analytically \cite{presolo} and with a detailed computer experiments \cite{prlcomm}. The question which naturally emerges at this point is how to assure thermodynamic equilibrium if we cannot define a Hamiltonian of the system. This aspect is discussed in the next section.
...
region should reproduce, and $g_k(r)$ is the \redc{{\it average}} hybrid RDF of the $k$-th
iteration. \redc{It must be noticed that the RDF correction force $\v F^{\textrm{rdf}}$
  only depends on the
  ...
  In the IBI scheme~\eqref{eqn:ibi},
  ...
  The spatial dependency is added later by the  prefactor
...
% \redc{In other words, although the molecules
%   in range $d_{\textrm{AT}} < x < d_{\textrm{AT}} + r_c$ are assigned
%   by $w=1$, they are conceptionally treated as hybrid molecules with
%   both resolutions: an atomistic resolution and a vanishing
...
\newblock Multiscale simulation of soft matter: From scale bridging to adaptive
  resolution.
\newblock {\em Annu. Rev. Phys. Chem.}, \textbf{2008}, \textit{59}, 545--571.

\bibitem{jcp}
Praprotnik, M.; Delle~Site, L.; Kremer, K.
\newblock Adaptive resolution molecular-dynamics simulation: Changing the
  degrees of freedom on the fly.
\newblock {\em J. Chem. Phys.}, \textbf{2005}, \textit{123}, 224106.
...
\newblock {\em Phys. Rev. E}, \textbf{2006}, \textit{73}, 066701.
...
\newblock Energy conservation in adaptive hybrid atomistic/coarse-grain
  molecular dynamics.
\newblock {\em J. Chem. Theory Comput.}, \textbf{2007}, \textit{3}, 1100.
...
\newblock {\em J. Chem. Theory Comput.}, \textbf{2008}, \textit{4}, 217.
...
\newblock {\em Eur. Phys. J. E: Soft Matter Biol. Phys.}, \textbf{2009}, \textit{28}, 221--229.

\bibitem{debash}
Mukherji, D.; van~der Vegt, N. F. A.; Kremer, K.; Delle~Site, L.
\newblock Kirkwood-buff analysis of liquid mixtures in an open boundary
  simulation.
\newblock {\em J. Chem. Theory Comput.}, \textbf{2012},  \textit{8}, 375--379.

\bibitem{jstatphyskurt}
...
\newblock {\em J. Stat. Phys.}, \textbf{2011}, \textit{145}, 946--966.
...
\newblock {\em Phys. Rev. Lett.}, \textbf{2010}, \textit{104}, 250201.
...
\newblock {\em Phys. Chem. Chem. Phys.}, \textbf{2011}, \textit{13}, 10510--10519.

\bibitem{raffaello}
Potestio, R.; Delle~Site, L.
\newblock {Quantum locality and equilibrium properties in low-temperature
  parahydrogen: A multiscale simulation study}.
\newblock {\em J. Chem. Phys.}, \textbf{2012}, \textit{136}, 54101.

\bibitem{berendsen1987missing}
Berendsen, H. J. C.; Grigera, J. R.; Straatsma, T. P.
\newblock The missing term in effective pair potentials.
\newblock {\em J. Phys. Chem.}, \textbf{1987}, \textit{91}, 6269--6271.

\bibitem{gromacs}
Hess, B.; Kutzner, C.; van~der Spoel, D.; Lindahl, E.
\newblock Gromacs 4: Algorithms for highly efficient, load-balanced, and
  scalable molecular simulation.
\newblock {\em J. Chem. Theory Comput.}, \textbf{2008}, \textit{4}, 435--447.

\bibitem{ruehle2009versatile}
...
\newblock {\em J. Chem. Theory Comput.}, \textbf{2009}, \textit{5}, 3211--3223.
